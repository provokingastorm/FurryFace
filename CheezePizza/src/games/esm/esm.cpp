...
HGE *hge = 0;
//ESMGameSession*			g_Game				= 0;
hgeResourceManager*     g_ResourceManager   = 0;
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	if( InitializeEngine() )
	{
		g_ResourceManager = new hgeResourceManager("./Tetris/TetrisGame.res");
		g_ResourceManager->Precache( 1 );
		//g_Tetris->Start(g_Engine, g_ResourceManager);
